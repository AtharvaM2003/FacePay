...
const Validation = () => {
    ...
    if (!emailregex.test(emailWithDomain)) {
        swal("", "Enter a valid username /वैध वापरकर्ता पत्ता प्रविष्ट करा!", "warning");
        return false;
    }
...
const RegisterUser = async () => {
    ...
    try {
        ...
        const userSnapshot = await get(child(dbRef, `UsersList/${phoneInput.value}`));
        if (userSnapshot.exists()) {
            ...
            swal("User added successfully!", "please Log In at next step./ग्राहक यशस्वीरित्या जोडला गेला! पुढच्या टप्प्यात लॉगिन करा.", "success").then(() => {
